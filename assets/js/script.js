 ...
 * and after the user's answer har been processed
 */
function runGame(gameType) {
    ...
    if (gameType === 'addition'){
        ...
        throw `Unknown game type ${gameType}. Abortting!`;
    }
}
/**
 * Chcech the answer agains the first element in
 ...
 * dorectly from the dom, and teturns correct answer.
 */
